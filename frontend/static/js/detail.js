  ...
  const contents = {
    ...
    lifestyle: {
      ...
      rent: {
        ...
        &#149 특약 꼭 작성(하자 부분, 수리 책임 등) <br>
        &#149 주택임대차등기 신청<br><br>

        <h2>3 단계 전입신고 & 확정일자</h2>
      ...
      shopping: {
        ...
        text: `
        <h2>1 단계 가격 비교</h2>
        &#149 네이버 가격비교, 다나와(가격비교 사이트) 활용<br>
    ...
    health: {
      ...
      school_work_safety: {
        ...
        <hr><h3>기본 안전 수칙</h3>
        &#149 비상구 위치 확인<br>
        &#149 소화기·자동심장충격기(AED) 위치 확인<br>
        &#149 안전모·보호장비 착용(해당 시)<br>
        &#149 엘리베이터 과적 금지<br><br>

        <h3>학교 안전</h3>
        &#149 실험실 안전수칙 준수<br>
        &#149 체육 활동 전, 스트레칭<br>
        &#149 화재·지진 대피 훈련 참여<br><br>

        <h3>직장 안전</h3>
        &#149 산업안전교육 정기 참여<br>
        &#149 컴퓨터 작업은 1시간마다 스트레칭<br><br>
        `,
        //영상미기재
        youtube: "",
      },
      emergency: {
        ...
        <hr><h2>심정지 의심 상황</h2>
        &#149 반응 없음<br>
        &#149 호흡 없음 또는 비정상적 호흡<br><br>

        <h2>1 단계 반응 확인</h2>
        &#149 어깨 두드리며 의식 확인<br><br>

        <h2>2 단계 119 신고</h2>
        &#149 특정 사람 지목(예: 거기 빨간색 옷 입으신분!)하여 자동심장충격기(AED) 가져오라고 요청<br><br>

        <h2>3 단계 가슴압박</h2>
        &#149 양손 깍지 끼고 가슴 중앙을 30회 강하게 압박<br>
        &#149 분당 100~120회 속도 유지<br><br>

        <h2>4 단계 자동심장충격기(AED) 사용</h2>
        &#149 전극패드 붙이고 음성 안내에 따라 진행<br><br>
      ...
      disaster: {
        ...
        &#149 불이 난 곳에서 즉시 벗어날 것<br>
        &#149 계단 이용 (엘리베이터 금지)<br>
        &#149 젖은 수건으로 코·입 가리기<br><br>

        <h2>지진 발생 시</h2>
        &#149 탁자 아래로 들어가기<br>
        &#149 머리 보호하기<br>
        &#149 건물 밖 이동 시 떨어지는 물체 주의<br><br>

        <h2>폭우·침수 시</h2>
        &#149 지하·반지하 공간 즉시 대피<br>
        &#149ㄴ 자동차 침수 시 창문 열고 탈출<br><br>
